...
if __name__ == "__main__":
    master_csv_file = "all-cards-png.csv"  # Replace with your master CSV file name
    subset_csv_file = "image_list.csv"  # Replace with your subset CSV file name
    output_csv_file = "difference.csv"  # Replace with your desired output CSV file name
